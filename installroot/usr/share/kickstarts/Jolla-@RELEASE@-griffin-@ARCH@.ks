# DisplayName: Jolla griffin/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: griffin
# DeviceVariant: griffin
# Brand: Jolla
...
repo --name=adaptation-community-common-griffin-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration griffin
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/griffin
